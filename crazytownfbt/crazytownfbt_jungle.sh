cleos -u http://jungle.iryo.network:8888 push action eosio buyram '["crazytownfbt","crazytownfbt","90.0000 EOS"]' -p crazytownfbt@active

cleos -u http://jungle.iryo.network:8888 set contract crazytownfbt crazytownfbt -p crazytownfbt@active

cleos -u http://jungle.iryo.network:8888 push action  crazytownfbt init '[""]' -p crazytownfbt@active

cleos -u http://jungle.iryo.network:8888 get table crazytownfbt crazytownfbt global
{
  "rows": [{
      "released_ctn": 0,
      "state": 0
...
cleos -u http://jungle.iryo.network:8888 set account permission crazytownfbt active '{"threshold": 1,"keys": [{"key": "EOS6BxMKAFZ2oPGwTU58syzm7FA4pXxtJcNxosmmGt3xhDoiKxR8h","weight": 1}],"accounts": [{"permission":{"actor":"crazytownfbt","permission":"eosio.code"},"weight":1}]}' owner -p crazytownfbt
...
cleos -u http://jungle.iryo.network:8888 push action  crazytownfbt setaccount '["ethdofuckeos", "1000000"]' -p crazytownfbt@active

cleos -u http://jungle.iryo.network:8888 get table crazytownfbt ethdofuckeos accounts
{
  "rows": [{
...
cleos -u http://jungle.iryo.network:8888 get table crazytownfbt bookwilllook accounts
{
  "rows": [],
  "more": false
}

cleos -u http://jungle.iryo.network:8888 push action  crazytownfbt withdraw '["ethdofuckeos", "1000000"]' -p ethdofuckeos@active
Error 3050003: eosio_assert_message assertion failure
Error Details:
assertion failure with message: token is locked
pending console output: 

cleos -u http://jungle.iryo.network:8888 push action  crazytownfbt changelock '[""]' -p crazytownfbt@active
...
cleos -u http://jungle.iryo.network:8888 get table dacincubator crazytownfbt accounts
...
#######################################################
cleos -u http://jungle.iryo.network:8888 set contract dacincubator eosio.token -p dacincubator@active
...
cleos -u http://jungle.iryo.network:8888 set account permission dacincubator active '{"threshold": 1,"keys": [{"key": "EOS4zfyNRNVFWwMr4tkvNyCvhWqSqB5eUb7vYSxD7GntPidWMtWEy","weight": 1}],"accounts": [{"permission":{"actor":"dacincubator","permission":"eosio.code"},"weight":1}]}' owner -p dacincubator
...
cleos -u http://jungle.iryo.network:8888 push action  dacincubator create '["dacincubator", "1000000.0000 CTN"]' -p dacincubator@active
...
cleos -u http://jungle.iryo.network:8888 push action  dacincubator issuer '["crazytownfbt", "1000.0000 CTN",""]' -p dacincubator@active


################################
cleos -u http://jungle.iryo.network:8888 set contract dacincubator dacincubator -p dacincubator@active
...
cleos -u http://jungle.iryo.network:8888 push action  dacincubator init '[""]' -p dacincubator@active
...
cleos -u http://jungle.iryo.network:8888 push action  crazytownfbt setaccount '["bookwilllook", "1000000"]' -p crazytownfbt@active

cleos -u http://jungle.iryo.network:8888 get table crazytownfbt bookwilllook accounts
{
  "rows": [{
      "remain_amount": 11277415,
      "total_amount": 1127 7415
    }
  ],
  "more": false
}
